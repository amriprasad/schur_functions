...
\begin{proof}
  ...
  Moreover, the class of polynomials $S_\lambda$ satisfy the Pieri rule, just like the Schur polynomials.
  This suffices for the identities of Theorem~\ref{theorem:schur-to-eh} to hold with $s_\lambda$ replaced by $S_\lambda$.
...
Let $S$ be any set of points, and $v:S\times S\to R$ be any function (we think of $v$ as a \emph{weight function}).
