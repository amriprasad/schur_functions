...
\begin{proof}
  ...
  Schematically, this method for reconstituting $\lambda$ from hooks in the right hand side of Giambelli's identity is described by the following figure:
  \begin{displaymath}
    \ydiagram[*(red)]{5,1,1,1}*[*(green)]{0,1+2,1+1,1+1}*[*(blue)]{0,0,2+1,2+1} = \det
    \begin{pmatrix}
      \ydiagram[*(red)]{5,1,1,1} & \ydiagram[*(red)]{1+4}*[*(green)]{1,1,1} &  \ydiagram[*(blue)]{1,1}*[*(red)]{1+4}\\
      \ydiagram[*(green)]{1+1}*[*(red)]{1,1,1,1} & \ydiagram[*(green)]{2,1,1}& \ydiagram[*(green)]{1+1}*[*(blue)]{1,1}\\
      \ydiagram[*(red)]{1,1,1,1} & \ydiagram[*(green)]{1,1,1} & \ydiagram[*(blue)]{1,1}
    \end{pmatrix}
  \end{displaymath}
\end{proof}
