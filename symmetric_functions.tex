...
\begin{example}
  ...
  \end{displaymath}
  The boxes in the horizontal strip added at the $i$th stage are filled with the number $i$.
\end{example}
\begin{example}
...
\begin{example}
  ...
  Accordingly, we enter $3$ into the bottom-most boxes in the three leftmost columns, and also into one rightmost box in the first column:
  \begin{displaymath}
